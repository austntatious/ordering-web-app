...
ActiveRecord::Schema.define(version: 20151209125922) do
  ...
  create_table "users", force: true do |t|
    ...
    t.boolean  "has_confirmed_phone",                             default: false, null: false
    t.string   "phone_confirmation_code",                         default: "",    null: false
  end
